...
?>
					...
					<h3><?php echo $subscribed ? 'Danh sách' : 'Khác'?></h3>
...
?>
				...
				<div class="col-sm-8">
					<h3>Chi tiết: <?php echo html($viewstream['name'])?> &ndash; <?php echo count($items)?> of <?php echo $countitems?> <?php echo ($countitems==1) ? 'item' : 'items'?><?php echo html($suffix)?></h3>
<?php
			$oneoutput=false;
